 ...
 * Cursor adapter base class for RecyclerView
 */
        ...
        RecyclerView.Adapter<VH>
{
    ...
    protected abstract void onBindViewHolder(VH holder, Cursor cursor, int viewType);
    ...
    public void onBindViewHolder(VH holder, int position)
    {
        ...
        onBindViewHolder(holder, mCursor, getItemViewType(position));
    }

    @Override
    public long getItemId(int position)
    {
        if(mDataValid && mCursor != null && !mCursor.isClosed() && mCursor.moveToPosition(position)){
